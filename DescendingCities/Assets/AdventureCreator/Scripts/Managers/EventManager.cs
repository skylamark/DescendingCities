...
namespace AC
{
	...
	public class EventManager : MonoBehaviour
	{
		...
		public delegate void Call_OnHandleSound (Sound sound, AudioSource audioSource, AudioClip audioClip, float fadeTime);
		/** An event triggered when a Sound component plays audio */
		public static event Call_OnHandleSound OnPlaySound;
		/** An event triggered when a Sound component stops playing audio */
		public static event Call_OnHandleSound OnStopSound;
