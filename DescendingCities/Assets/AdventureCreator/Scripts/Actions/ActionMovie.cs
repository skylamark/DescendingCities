...
namespace AC
{
	...
	public class ActionMovie : Action
	{
		...
		override public void ShowGUI (List<ActionParameter> parameters)
		{
			...
			EditorGUILayout.HelpBox ("On standalone, this method is deprecated in Unity 2017.2 and later.", MessageType.Warning);

			#else

			EditorGUILayout.HelpBox ("On standalone, this method is only available in Unity 5 or Unity Pro.", MessageType.Warning);
		...
		protected void CreateFullScreenMovie ()
		{
		...
		protected void EndFullScreenMovie ()
		{
