	...
	public class Moveable_PickUpEditor : DragBaseEditor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			if (_target.actionListSource == ActionListSource.InScene)
			{
				...
				if (_target.interactionOnGrab != null && _target.interactionOnGrab.source == ActionListSource.InScene && _target.interactionOnGrab.useParameters && _target.interactionOnGrab.parameters.Count > 0)
				{
					EditorGUILayout.BeginHorizontal ();
				...
				else if (_target.interactionOnGrab != null && _target.interactionOnGrab.source == ActionListSource.AssetFile && _target.interactionOnGrab.assetFile != null && _target.interactionOnGrab.assetFile.useParameters && _target.interactionOnGrab.assetFile.parameters.Count > 0)
				{
					EditorGUILayout.BeginHorizontal ();
					_target.moveParameterID = Action.ChooseParameterGUI ("PickUp parameter:", _target.interactionOnGrab.assetFile.parameters, _target.moveParameterID, ParameterType.GameObject, -1, "The GameObject parameter to automatically assign as this pickup object");
					EditorGUILayout.EndHorizontal ();
				}
			...
			else if (_target.actionListSource == ActionListSource.AssetFile)
			{
				...
				if (_target.actionListAssetOnGrab != null && _target.actionListAssetOnGrab.useParameters && _target.actionListAssetOnGrab.parameters.Count > 0)
				{
					EditorGUILayout.BeginHorizontal ();
					_target.moveParameterID = Action.ChooseParameterGUI ("PickUp parameter:", _target.actionListAssetOnGrab.parameters, _target.moveParameterID, ParameterType.GameObject, -1, "The GameObject parameter to automatically assign as this pickup object");
					EditorGUILayout.EndHorizontal ();
				}
				...
				{
					EditorGUILayout.BeginHorizontal ();
					_target.dropParameterID = Action.ChooseParameterGUI ("PickUp parameter:", _target.actionListAssetOnDrop.parameters, _target.dropParameterID, ParameterType.GameObject, -1, "The GameObject parameter to automatically assign as this pickup object");
					EditorGUILayout.EndHorizontal ();
				}
			}
			EditorGUILayout.EndVertical ();
